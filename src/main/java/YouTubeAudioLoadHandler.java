...
public class YouTubeAudioLoadHandler extends RunableHandler {
    ...
    public void run() {
        ...
        YouTubeAudioLoader loader = new YouTubeAudioLoader("C:/Users/TheDAX/Desktop/TelegramBot/MusicBot/src/main/resources/audioFiles/" + requestInfo.getMessage().getChatId());
